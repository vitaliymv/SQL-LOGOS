...
SELECT * FROM books;
SELECT * FROM books WHERE id = 5 OR id = 10 OR id = 13; #books with id 5, 10, 13
SELECT * FROM books WHERE numbers_of_page > 150; #books with numbers pages > 150
SELECT * FROM books WHERE author_age > 30; #books with authors`s age > 30;
SELECT * FROM books WHERE author_awards IS NULL; #books with authors not have awards
SELECT * FROM books WHERE author_email = 'Tay@ukr.net'; #book with select author`s email 
SELECT * FROM books WHERE ISBN = 'RR-0123_50'; #book with select ISBN 
SELECT * FROM books WHERE category = 'Fantasy'; #books with select category
SELECT * FROM books WHERE numbers_of_page > 200 AND author_age > 25; #books with numbers page > 200 and age author`s > 25;
SELECT * FROM books WHERE category = 'Comedy' OR category = 'Detective'; #books with select category 
SELECT * FROM books ORDER BY title_of_the_book; #books sort name
SELECT * FROM books ORDER BY author_email; #books sort email
SELECT * FROM books ORDER BY numbers_of_page; #books sort numbers of page ASC
SELECT * FROM books ORDER BY numbers_of_page DESC; #books sort numbers of page DESC
SELECT DISTINCT category FROM books; #books with unique category
SELECT DISTINCT author_name FROM books; #books with unique category
SELECT * FROM books WHERE publishing_date > '2000-01-01'; #books publishing after 2000-01-01
SELECT * FROM books WHERE publishing_date < '2010-01-01'; #books publishing until 2010-01-01
